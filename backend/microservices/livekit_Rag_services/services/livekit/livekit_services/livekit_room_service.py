...
from backend.microservices.livekit_Rag_services.services.Speec_to_text_service.sst_whisper import STTWhisper
...
class   LivekitRoomServices:
    ...
    def livekit_token(self, api_key, api_secret, room_name: str, user_name: Optional[str]):
        metadata = {
    ...
    async def connect_worker(self, token: str, session_id: str):
        ...
        try:
            ...
            await self.cleanup()
            await self.ss_service.close_session_by_id(session_id=session_id)
