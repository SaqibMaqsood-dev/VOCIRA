...
from services.text_speech.piper_services import tts_converter
            ...
            if "INAPPROPRIATE" in intent:
                ...
                try:
                    if rag_state.retriever:
                        ...
                        # Fallback to general conversational text if no verified context found
                        if "couldn't find any verified information" in ai_response_text:
